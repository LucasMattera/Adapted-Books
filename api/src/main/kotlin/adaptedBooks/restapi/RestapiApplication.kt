	...
	override fun run(vararg args: String?) {
		...
		val leviatan =
				Libro(
					...
					leviatanImagen,
					leviatanLinks,
					LocalDate.parse("07-06-2012",formatter)
				)
		libros.add(leviatan)
		...
		val abadon = 
				Libro(
					...
					abadonImagen,
					leviatanLinks,
					LocalDate.parse("04-06-2013",formatter)
				)
		libros.add(abadon)
		...
		val akira = 
				Libro(
					...
					"Katsuhiro Otomo" ,
					"Japon",akiraImagen,
					akiraLinks,LocalDate.parse("20-12-1982",formatter)
				)
  		libros.add(akira)
		...
		val cdhyf1 = 
				Libro(
					...
					cdhyf1Imagen,
					cdhyfLinks,
					LocalDate.parse("06-08-1996",formatter)
				)
		libros.add(cdhyf1)
		...
		val cdhyf2 = 
				Libro(
					...
					cdhyf2Imagen,
					cdhyfLinks,
					LocalDate.parse("16-11-1998",formatter)
				)
		libros.add(cdhyf2)
		...
		val cdhyf3 = 
				Libro(
					...
					cdhyf3Imagen,
					cdhyfLinks,
					LocalDate.parse("08-08-2000",formatter)
				)
		libros.add(cdhyf3)
		...
		val cdhyf4 = 
				Libro(
					...
					cdhyf4Imagen,
					cdhyfLinks,
					LocalDate.parse("26-10-2005",formatter)
				)
		libros.add(cdhyf4)
		...
		val cdhyf5 = 
				Libro(
					...
					cdhyf5Imagen,
					cdhyfLinks,
					LocalDate.parse("12-07-2011",formatter)
				)
		libros.add(cdhyf5)
		...
		val HPPiedraFilosofal = 
				Libro(
					"Harry Potter y la piedra filosofal",
					"J.K. Rowling",
					"Reino Unido",
					HPPiedraFilosofalImagen,
					HPPiedraFilosofalLinks,
					LocalDate.parse("30-06-1997",formatter)
				)
		...
		val HPCamaraSecreta = 
				Libro(
					...
					"J.K. Rowling",
					"Reino Unido",
					HPCamaraSecretaImagen,
					HPCamaraSecretaLinks,
					LocalDate.parse("02-07-1998",formatter)
				)
		...
		val HPPrisionero = 
				Libro(
					...
					HPPrisioneroImagen,
					HPPrisioneroLinks,
					LocalDate.parse("08-07-1999",formatter)
				)
		...
		val HPCaliz = 
				Libro(
					...
					HPCalizImagen,
					HPCalizLinks,
					LocalDate.parse("08-07-2000",formatter)
				)
		libros.add(HPCaliz)
		...
		val HPFenix = 
				Libro(
					...
					HPFenixImagen,
					HPFenixLinks,
					LocalDate.parse("21-06-2003",formatter)
				)
		libros.add(HPFenix)
		...
		val HPPincipe = 
				Libro(
					...
					HPPincipelImagen,
					HPPincipeLinks,
					LocalDate.parse("16-07-2005",formatter)
				)
		...
		val HPReliquiasLinks = listOf<String>("https://www.youtube.com/watch?v=yU1v1JxJfRI",
		...
		val HPReliquias = 
				Libro(
					...
					HPReliquiasImagen,
					HPReliquiasLinks,
					LocalDate.parse("21-07-2007",formatter)
				)
		...
		val HPLegadoMaldito = 
				Libro(
					...
					"J.K. Rowling",
					"Reino Unido",
					HPLegadoMalditoImagen,
					HPLegadoMalditoLinks,
